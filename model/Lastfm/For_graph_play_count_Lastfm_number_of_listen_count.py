...
plt.title(f'LastFM Performance Metrics vs Minimum Listen Count (Top-{K} Recommendation)')
fig.tight_layout()
plt.savefig('LastFM_Performance_Metrics_vs_Minimum_Listen_Count.png')
plt.show()