...
#
#
# K를 2로 한 이유 : MSD데이터는 평균적으로 한사람당 1번에서 2번 노래를 듣기 때문에 K가 10개라면 10개의 관련된 장르의 노래를 추천하지만
# 평가할 때는 추천한 노래를 사용자가 들었는지로 판별하기 때문에 관련된 장르의 음악을 많이 추천하더라도 지표가 낮아집니다.
# 따라서 MSD 데이터에서는 2개를 추천하게 설정했습니다.
# ======================================================================================
...
# 최종 병합된 데이터 파일 경로
FINAL_MERGED_CSV = '../../data/final-msd-data.csv'
# Top-N 추천에서 사용할 N값. "상위 몇 개의 아이템을 추천할 것인가?"를 결정합니다.
K = 2  #여러번 해보면서 데이터양을 고려해 선정한 최적의 K
